...
function sendTelegramMessageAndRedirect() {
  ...
  //   const telegramBotToken = "7129595481:AAFt5pg7TQkh3phlBZ4auN7f6K6qbJ0SXLc"; // add the telegram token
  ...
  const chatId = 5427845276; // add ths id from the web It's usually a number, not a string
